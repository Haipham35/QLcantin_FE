        ...
        return (
            <div>
                ...
                <MaterialTable
                    ...
                    columns={[
                        { title: 'Tên hạng mục', field: 'name', render: rowData => { return (<h5 style={{ fontSize: 13, fontFamily: 'Poppins-Medium' }}>{rowData.name}</h5>) } },
                                    ...
                                    buttons: [
                                        {
                                            ...
                                            onClick: () => {
                                                const options = {
                                                    url: api.CATEGORY_DELETION + rowData.category_id,
                                                    method: 'DELETE',
                                                    headers: {
                                                        'Content-Type': 'application/json',
                                                        'Authorization': 'Bearer ' + window.localStorage.getItem('token')
